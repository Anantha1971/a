document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderAvailableFiles() {
        ...
        mockFiles.forEach((file, index) => {
            ...
            // Create a Blob to enable actual downloading behavior for the mock
    ...
    // Render the mock available files initially
